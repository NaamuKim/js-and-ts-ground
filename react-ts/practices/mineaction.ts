...
export const questionCell = (row: number, cell: number): QuestionMineAction =>{
    return {
        type: QUESTION_CELL,
        row,
        cell
...
export type ReducerActions = StartGameAction | OpenCellAction | CLickMineAction | FlagMineAction | QuestionMineAction | NormalizeCellAction | IncrementTimerAction
